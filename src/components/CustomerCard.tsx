  ...
  if (customers.length === 0) {
    return (
      <div className="text-center py-16">
        ...
        <p className="text-gray-300">سيتم عرض عملائك هنا بمجرد إضافتهم من قبل المدير</p>
      </div>
    );
  }
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {customers.map((customer) => {
          ...
          return (
            <div
              key={customer._id}
              className={`bg-gradient-to-br from-gray-900 to-gray-950 rounded-2xl shadow-lg hover:shadow-xl transition-all p-6 border-2 ${
                isOverLimit 
            ...
            >
              <div className="flex justify-between items-start mb-4">
                ...
                {isAdmin && (
                  <button
                    ...
                    className="px-4 py-2 bg-gradient-to-l from-red-600 to-red-800 text-white rounded-lg font-semibold hover:shadow-lg transform hover:scale-105 transition-all"
                  >
                    إضافة تحصيل
                  </button>
                )}
              ...
              <div className="grid grid-cols-2 gap-4 mb-4">
                <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl p-4 border border-red-900">
                  <div className="flex items-center gap-2 mb-2">
                    <svg className="w-5 h-5 text-yellow-500" fill="currentColor" viewBox="0 0 20 20">
                      <path d="M10 2a6 6 0 00-6 6v3.586l-.707.707A1 1 0 004 14h12a1 1 0 00.707-1.707L16 11.586V8a6 6 0 00-6-6z" />
                    </svg>
                    <span className="text-xs font-medium text-gray-300">مديونية ذهب</span>
                  </div>
                  <p className="text-2xl font-bold text-yellow-400">{customer.goldDebt21.toFixed(2)}</p>
                  <p className="text-xs text-gray-400 mt-1">جرام عيار 21</p>
                </div>
                ...
                <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl p-4 border border-red-900">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-xs font-medium text-gray-300">مديونية نقدية</span>
                  </div>
              ...
              {creditLimit > 0 && (
                <div className={`rounded-xl p-3 border mb-4 ${
                  isOverLimit 
                    ...
                    : isNearLimit
                    ? 'bg-gradient-to-br from-orange-900 to-amber-900 border-orange-700'
                  ...
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-2">
                      ...
                      <span className={`text-xs font-medium ${
                        isOverLimit ? 'text-red-300' : isNearLimit ? 'text-orange-300' : 'text-purple-300'
                      }`}>الحد الائتماني</span>
                    </div>
                    <div className="text-end">
                      <p className={`text-sm font-bold ${
                        isOverLimit ? 'text-red-200' : isNearLimit ? 'text-orange-200' : 'text-purple-200'
              ...
              {hasOverdue && overdueStatus && (
                <div className="bg-gradient-to-br from-rose-900 to-red-900 border-2 border-rose-700 rounded-xl p-4">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <button
                      ...
                      className="text-xs px-3 py-1.5 bg-rose-700 text-white rounded-lg hover:bg-rose-800 transition-all font-semibold border border-rose-600"
                    >
                      عرض الكل
                    </button>
                  </div>
