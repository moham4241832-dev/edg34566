    ...
    return (
      <div className="text-center py-12">
        <div className="animate-pulse">
          ...
          <p className="text-blue-600 font-semibold">جاري تحميل التقارير...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-4 md:space-y-6 px-2 md:px-0">
      <div className="flex items-center gap-3 mb-4">
        ...
        <h3 className="text-xl md:text-2xl font-bold text-gray-900">📊 التقارير والإحصائيات</h3>
      </div>

      {/* الإحصائيات الرئيسية - محسنة للموبايل */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-6">
        <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl md:rounded-2xl shadow-lg p-4 md:p-6 text-white transform hover:scale-105 transition-all">
        ...
        <div className="bg-gradient-to-br from-amber-500 to-yellow-600 rounded-xl md:rounded-2xl shadow-lg p-4 md:p-6 text-white transform hover:scale-105 transition-all">
          <div className="flex items-center gap-2 mb-2">
        ...
        <div className="bg-gradient-to-br from-green-500 to-emerald-600 rounded-xl md:rounded-2xl shadow-lg p-4 md:p-6 text-white transform hover:scale-105 transition-all sm:col-span-2 lg:col-span-1">
          <div className="flex items-center gap-2 mb-2">
            <span className="text-xl md:text-2xl">💵</span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
        <div className="bg-gradient-to-br from-amber-500 to-yellow-600 rounded-xl md:rounded-2xl shadow-lg p-4 md:p-6 text-white">
        ...
        <div className="bg-gradient-to-br from-green-500 to-emerald-600 rounded-xl md:rounded-2xl shadow-lg p-4 md:p-6 text-white">
          <div className="flex items-center gap-2 mb-3">
            <span className="text-2xl">💵</span>
        ...
        <div className="overflow-x-auto -mx-4 md:mx-0">
          <table className="w-full min-w-[600px] md:min-w-0">
            <thead className="bg-gradient-to-r from-blue-50 to-indigo-50">
              <tr>
                <th className="px-3 md:px-6 py-3 text-start text-xs font-bold text-gray-700 uppercase">المندوب</th>
                <th className="px-3 md:px-6 py-3 text-start text-xs font-bold text-gray-700 uppercase">العملاء</th>
                <th className="px-3 md:px-6 py-3 text-start text-xs font-bold text-gray-700 uppercase">ذهب (ج)</th>
                <th className="px-3 md:px-6 py-3 text-start text-xs font-bold text-gray-700 uppercase">نقدي (£)</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-200">
              {salesStats.map((stat, index) => (
                <tr key={index} className="hover:bg-blue-50 transition-colors">
                  <td className="px-3 md:px-6 py-3 md:py-4 text-sm font-medium text-gray-900">{stat.name}</td>
                  <td className="px-3 md:px-6 py-3 md:py-4 text-sm text-gray-700">
                    <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-bold bg-blue-100 text-blue-800">
                      {stat.customers}
                    </span>
                  </td>
                  <td className="px-3 md:px-6 py-3 md:py-4 text-sm font-bold text-amber-700">{stat.gold.toFixed(2)}</td>
                  <td className="px-3 md:px-6 py-3 md:py-4 text-sm font-bold text-green-700">{stat.cash.toFixed(2)}</td>
                </tr>
              ))}
            </tbody>
          </table>
